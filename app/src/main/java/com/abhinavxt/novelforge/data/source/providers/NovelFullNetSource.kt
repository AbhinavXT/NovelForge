 ...
 */
class NovelFullNetSource : BrowseSource {
    ...
    // The novelfull engine's standard list pages; hot-novel is the verified
    // one (previous getPopular). Genre pages unverified — not offered.
    ...
    override suspend fun browse(
        ...
        try {
            val url = "$baseUrl/${orderBy ?: "hot-novel"}?page=$page"
            ...
            Logger.e("NovelFullNet", "browse error (p$page)", e)
        }
