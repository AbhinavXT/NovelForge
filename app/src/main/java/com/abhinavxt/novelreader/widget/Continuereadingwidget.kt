...
class ContinueReadingWidget : GlanceAppWidget() {
    ...
    companion object {
        ...
        fun launchAppIntent(context: Context): Intent {
            return Intent(Intent.ACTION_MAIN).apply {
                ...
                component = ComponentName(
                    context.packageName,
                    "com.abhinavxt.novelreader.MainActivity"
                )
        ...
        const val EXTRA_NOVEL_ID = "com.abhinavxt.novelreader.widget.NOVEL_ID"
        const val EXTRA_NOVEL_URL = "com.abhinavxt.novelreader.widget.NOVEL_URL"
        const val EXTRA_CHAPTER_ID = "com.abhinavxt.novelreader.widget.CHAPTER_ID"
        const val EXTRA_CHAPTER_URL = "com.abhinavxt.novelreader.widget.CHAPTER_URL"
    }
}
